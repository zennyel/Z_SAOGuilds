package com.zennyel.saodark.config;
...
public class MessagesFileManager {
    ...
    Logger logger = Guilds.getPlugin(Guilds.class).getLogger();

    public void MessagesFileManager(Guilds plugin){
        this.plugin = plugin;
    ...
    public void saveMessagesConfig() {
        ...
        try {
            ...
            logger.severe("Could not save messages.yml");
            logger.severe("&4Check the below message for the reasons!");
            e.printStackTrace();
        }
    }
